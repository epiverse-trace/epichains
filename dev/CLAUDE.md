...
- Design decisions taken during development of the package, along with
  ...
  [design principles
  vignette](https://github.com/epiverse-trace/epichains/blob/main/vignettes/design-principles.Rmd)
...
- **Commit messages**: Describe what the code does, never reference
  issues
  - Good: “Standardise return structure for simulate_chains”
  - Bad: “Standardise return structure for simulate_chains (#1142)”
...
- **NEWS items**: Describe user-facing changes, never reference issues
  or PRs
  - Good: “Added S3 methods for epichains objects”
  - Bad: “Added S3 methods for epichains (#1142)”
...
test_that("simulate_chains works as expected with default arguments", {
  # test code
})
```
...
- Don’t reference issue numbers - those are for PRs, not NEWS. Rather
  reference the PR number enclosed in round brackets. Example “Added
  feature x (#1)”
...
- Use sentence case for function titles, not title case
  - Good: `#' Simulate infections`
  - Bad: `#' Simulate Infections`

## Additional Context

See
<https://github.com/epiverse-trace/.github/blob/main/CONTRIBUTING.md>
