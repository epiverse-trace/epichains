...
Provides methods to simulate and analyse the size and length of
branching processes with an arbitrary offspring distribution. These can
be used, for example, to analyse the distribution of chain sizes or
...
- Zhian N. Kamvar <zkamvar@gmail.com>
  ([ORCID](https://orcid.org/0000-0003-1458-7108)) \[contributor\]

- Hugo Gruson <hugo@data.org>
  ([ORCID](https://orcid.org/0000-0002-4094-1476)) \[contributor,
  reviewer\]

- Karim Mané <karim.mane@lshtm.ac.uk>
  ([ORCID](https://orcid.org/0000-0002-9892-2999)) \[reviewer\]

- Pratik Gupte <pratik.gupte@lshtm.ac.uk>
  ([ORCID](https://orcid.org/0000-0001-5294-7819)) \[reviewer\]
