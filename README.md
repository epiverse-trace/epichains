...
#> 
#>   Azam J, Finger F, Funk S (????). _epichains: Simulating and Analysing Transmission Chain Statistics
#>   Using Branching Process Models_. R package version 0.0.0.9999,
#>   https://epiverse-trace.github.io/epichains/, <https://github.com/epiverse-trace/epichains>.
#> 
