...
Here we investigate the effect on outbreak sizes, but the same approaches could be used for investigating chain lengths (using the `statistic` argument to `simulate_summary()`) or the time progression of outbreaks (using the `simulate_chains()` function).
