...
separate index case. What are the likely transmission properties
(reproduction number and/or superspreading coefficient) that
generated these clusters (assuming these parameters are the same across all the clusters)?
...
summaries.
4. A threshold of chain summaries that are considered too large to be consistent with a reproduction number of $R<1$ (e.g., $N$ or $T$ generations in total).
:::
