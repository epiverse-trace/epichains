...
{{ packagename }} is an R package to simulate, analyse, and visualize the size 
...
{{ package name }} re-implements [bpmodels]("https://github.com/epiverse-trace/bpmodels/") by providing dedicated classes that allow easy manipulation and interoperability with other existing
...
Specific use cases of {{ packagename }} can be found in 
...
Please note that the {{ packagename }} project is released with a [Contributor Code of Conduct](https://github.com/epiverse-trace/.github/blob/main/CODE_OF_CONDUCT.md). 
